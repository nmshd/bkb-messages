    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "char(20)", nullable: false),
                    MessageId = table.Column<string>(type: "char(20)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Address = table.Column<string>(type: "char(36)", nullable: false),
                    MessageId = table.Column<string>(type: "char(20)", nullable: false),
                    EncryptedKey = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    ReceivedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReceivedByDevice = table.Column<string>(type: "char(20)", nullable: true),
                    RelationshipId = table.Column<string>(type: "char(20)", nullable: false)
                },
                constraints: table =>
                {
